...
<div class="product-tags">
  ...
  <span class="product-tag">アセテクト</span>
</div>
</div>
...
<div class="contents-links">
  ...
  <a href="products/acetect/">アセテクト 広告表現チェックシート</a>
...
| やりたいこと                          | 見るページ                             |
| ------------------------------- | --------------------------------- |
| 📋 アセテクトの広告表現をチェックしたい | [広告表現チェックシート](products/acetect.md) |
| 💡 LEチームの判断基準・グレーゾーンの考え方を知りたい   | [法律の考え方](le-philosophy.md)    |
